...
const rules = {
  ...
  'no-console-in-components': require('./no-console-in-components'),
  ...
  'prefer-typed-hooks': require('./prefer-typed-hooks'),
  ...
  'require-jsdoc-on-complex-components': require('./require-jsdoc-on-complex-components'),
